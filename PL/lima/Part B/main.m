...
%Generate clusters
[gridpartition_clustering, subtractive_clustering, fuzzycmeans_clustering] = generate_clustering(in, out);

%Optimize clusters
[grd_back, grd_hybrid, sub_back, sub_hybrid, fcm_back, fcm_hybrid] = ...
    optimization(train_dataset, gridpartition_clustering, subtractive_clustering, fuzzycmeans_clustering);
