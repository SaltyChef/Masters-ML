function [gridpartition_back, gridpartition_hybrid, subtractive_back, subtractive_hybrid, fuzzycmeans_back, fuzzycmeans_clustering] = optimization(train_dataset, gridpartition_clustering, subtractive_clustering, fuzzycmeans_clustering)
